package itchat4j.service.impl;


import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import itchat4j.beans.BaseMsg;
import itchat4j.core.Core;
import itchat4j.core.MsgCenter;
import itchat4j.service.ILoginService;
import itchat4j.utils.Config;
import itchat4j.utils.MyHttpClient;
import itchat4j.utils.SleepUtils;
import itchat4j.utils.enums.ResultEnum;
import itchat4j.utils.enums.RetCodeEnum;
import itchat4j.utils.enums.StorageLoginInfoEnum;
import itchat4j.utils.enums.URLEnum;
import itchat4j.utils.enums.parameters.BaseParaEnum;
import itchat4j.utils.enums.parameters.LoginParaEnum;
import itchat4j.utils.enums.parameters.StatusNotifyParaEnum;
import itchat4j.utils.enums.parameters.UUIDParaEnum;
import itchat4j.utils.tools.CommonTools;
					...
					try {
						...
						if (retcode.equals(RetCodeEnum.UNKOWN.getCode())) {
							...
							if (selector.equals("2")) {
								if (msgObj != null) {
									try {
//										System.out.println(" 获取一条消息2，原始数据这样的：");
